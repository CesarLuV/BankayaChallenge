...
from common.constants import BASE_EXTERNAL_API_URL
...
class KantoServices:
    def __init__(self, locations_in: Location) -> None:
        ...
        locations_api = consume_api(
            uri=BASE_EXTERNAL_API_URL.format(path=KANTO))
    ...
    def __str__(self) -> str:
        s = f'Valid locations: {self.__valid_locations}\n'
        s += f'Invalid locations: {self.__invalid_locations}'
        return s
